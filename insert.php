...
$query=mysqli_query($con, "insert into tblusers(FirstName,LastName, MobileNumber, Email, Address,Roomname,ProfilePic) values('$fname','$lname', '$contno', '$email', '$add','$Roomname','$imgnewfile' )");
if ($query) {
...
<div class="signup-form">
    <form  method="POST" enctype="multipart/form-data" >
		<h2>INSERT</h2>
		<p class="hint-text">LESSOR DETAIL</p>
		...
		<div class="form-group">
            <input class="form-control" name="text1" placeholder="Roomname" required="true"></textarea>
        </div>

             <div class="form-group">
        	<input type="file" class="form-control" name="profilepic"  required="true">
        	<span style="color:red; font-size:15px;">ONLY JPG/JPEG/PNG ARE ALLOWED</span>
        </div>      
	...
	<div class="text-center">VIEW ALREADY INSERTED DATA!!  <a href="new.php">VIEW</a></div>
</div>
</body>
</html>